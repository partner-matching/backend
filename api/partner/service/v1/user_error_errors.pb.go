...
func IsUserTagsEmpty(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == UserErrorReason_USER_TAGS_EMPTY.String() && e.Code == 500
}

func ErrorUserTagsEmpty(format string, args ...interface{}) *errors.Error {
	return errors.New(500, UserErrorReason_USER_TAGS_EMPTY.String(), fmt.Sprintf(format, args...))
}
...
func IsUpdateUser(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == UserErrorReason_UPDATE_USER.String() && e.Code == 500
}
