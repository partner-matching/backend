...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	...
	r.GET("/api/user/search/tags", _UserService_SearchUsersByTags0_HTTP_Handler(srv))
	...
	r.POST("/api/user/update", _UserService_UpdateUser0_HTTP_Handler(srv))
	r.GET("/api/user/recommend", _UserService_UsersRecommend0_HTTP_Handler(srv))
}
...
func _UserService_SearchUsersByTags0_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in SearchUsersByTagsReq
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationUserServiceSearchUsersByTags)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.SearchUsersByTags(ctx, req.(*SearchUsersByTagsReq))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _UserService_UsersRecommend0_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in UsersRecommendReq
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationUserServiceUsersRecommend)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.UsersRecommend(ctx, req.(*UsersRecommendReq))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*UsersRecommendReply)
		return ctx.Result(200, reply)
	}
}
...
func (c *UserServiceHTTPClientImpl) SearchUsersByTags(ctx context.Context, in *SearchUsersByTagsReq, opts ...http.CallOption) (*SearchUsersReply, error) {
	var out SearchUsersReply
	pattern := "/api/user/search/tags"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationUserServiceSearchUsersByTags))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *UserServiceHTTPClientImpl) UsersRecommend(ctx context.Context, in *UsersRecommendReq, opts ...http.CallOption) (*UsersRecommendReply, error) {
	var out UsersRecommendReply
	pattern := "/api/user/recommend"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationUserServiceUsersRecommend))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
