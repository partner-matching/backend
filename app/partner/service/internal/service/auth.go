...
func (s *PartnerService) UserRegister(ctx context.Context, req *v1.UserRegisterReq) (*v1.UserRegisterReply, error) {
...
func (s *PartnerService) UserLogin(ctx context.Context, req *v1.UserLoginReq) (*v1.UserLoginReply, error) {
	login := &biz.UserLogin{
		UserAccount:  req.UserAccount,
		UserPassword: req.UserPassword,
	}
...
func (s *PartnerService) UserLogout(ctx context.Context, _ *emptypb.Empty) (*emptypb.Empty, error) {
